...
public class GalleryActivity extends BasicActivity {
        ...
        switch (requestCode) {
            case 1: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    finish();
                    showToast(GalleryActivity.this, getResources().getString(R.string.please_grant_permisstion));
                }
            }
        }
    }
    ...
    private void recycleInit(){
        ...
        RecyclerView.Adapter galleryAdapter = new GalleryAdapter(this, getImagesPath(this));
    ...
    public ArrayList<String> getImagesPath(Activity activity){
        ...
        final int media = intent.getIntExtra(INTENT_MEDIA, -1);
//        if(intent.getStringExtra(INTENT_MEDIA).equals(GALLERY_VIDEO)){
