...
public class Util {
    ...
    public static boolean isStorageUrl(String uri){
        return Patterns.WEB_URL.matcher(uri).matches() && uri.contains("https://firebasestorage.googleapis.com/v0/b/sns-project-525dc.appspot.com/o/posts");
    }
