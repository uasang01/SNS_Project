...
public class ReadContentsView extends LinearLayout {
    ...
    private ArrayList<SimpleExoPlayer> videoArrayList = new ArrayList<>();
    ...
    public void setPostInit(PostInfo postInfo){
        ...
        ArrayList<String> formatList = postInfo.getFormat();
        ...
        for (int i = 0; i < contentsList.size(); i++) {
            ...
            if (format.equals("image")) {
                ...
                Glide.with(this).load(content).override(1000).thumbnail(0.1f).into(imageView);
            } else if (format.equals("video")) {
                final PlayerView playerView = (PlayerView) layoutInflater.inflate(R.layout.view_contents_video, this, false);
    ...
    public ArrayList<SimpleExoPlayer> getVideoArrayList() {
